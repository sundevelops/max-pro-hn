...
function HoverCTA({ className = '', isOpen = null }) {
  ...
  return (
    <a ref={btnRef} href="https://wa.me/50487866985?text=Hola,%20me%20interesa%20un%20iPhone%20Pro%20Max" className={`relative overflow-hidden inline-flex items-center justify-center bg-[#E8E8E8] text-[#111212] px-12 md:px-16 py-6 md:py-8 text-xl md:text-2xl rounded-[2.5rem] shadow-[0_0_40px_rgba(232,232,232,0.15)] group cursor-pointer border border-[#E8E8E8] w-full max-w-lg mt-8 mb-6 ${className}`}>
